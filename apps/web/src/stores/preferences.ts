...
export const messages = {
  "zh-CN": {
    appSubtitle: "本地工作台",
    brandNickname: "Dev Pilot · 本地项目驾驶舱",
    navProjects: "项目",
    navSettings: "设置",
    localOnly: "仅本地运行",
    noCloudSync: "无云端同步",
    ...
    updatesDescription: "检查 GitHub Release，发现新版本后可下载标准安装包或免安装版。",
    updatesAvailable: "发现新版本 {version}",
    updatesCurrent: "当前已是最新版本 {version}",
    updatesInstallHint: "推荐下载 Setup 安装包；已安装版本会直接覆盖升级。portable 用户可以下载免安装版手动替换。",
  ...
  "en-US": {
    ...
    brandNickname: "Dev Pilot · Local project cockpit",
    ...
    updatesDescription: "Checks GitHub Releases and offers the standard installer or portable build when a new version is available.",
    updatesAvailable: "Version {version} is available",
    updatesCurrent: "You are on the latest version {version}",
    updatesInstallHint: "Use the Setup installer for normal upgrades. Installed versions are upgraded in place; portable users can replace the portable exe manually.",
