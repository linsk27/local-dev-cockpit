...
export const messages = {
  "zh-CN": {
    ...
    performanceTooltip: "显示 Dev Cockpit 自身开销，不代表项目服务占用。",
    ...
    onboardingStepContextDetail: "复制当前项目状态，给 Codex、Cursor 或 Claude 接着处理。",
    onboardingAddRoot: "添加并扫描",
    onboardingPrivacy: "只读取本机项目元数据；默认不上传代码，也不写入项目目录。",
    ...
    welcomePrivacy: "仅在本机读取项目元数据；默认不上传代码，也不写入项目目录。",
    ...
    resourceCopySource: "复制项目地址",
    resourceSourceCopied: "项目地址已复制。",
    resourceSourceCopyFailed: "项目地址复制失败。",
    resourceSourceCopyFailedWithMessage: "项目地址复制失败：{message}",
    resourceAnalysis: "解析",
    resourceCopyToAi: "复制给 AI",
    resourceAiHandoffTitle: "交给 AI 继续处理",
    resourceAiHandoffDescription: "复制一段包含来源、摘要、证据和复核任务的上下文，用于粘贴到 Codex、Cursor 或 Claude。",
    resourceCopyContext: "复制上下文",
    resourceCopyingContext: "复制中",
    resourceContextCopied: "资源上下文已复制。",
    resourceCopyContextFailed: "资源上下文复制失败。",
    resourceCopyContextFailedWithMessage: "资源上下文复制失败：{message}",
    ...
    resourceRelatedDuplicate: "发现重复资源，建议合并或归档其中一个。",
    ...
    resourceAiContextPlaceholder: "复制后可粘贴到 Codex、Cursor 或 Claude。",
  ...
  "en-US": {
    ...
    resourceCopySource: "Copy URL",
    resourceSourceCopied: "Project URL copied.",
    resourceSourceCopyFailed: "Failed to copy project URL.",
    resourceSourceCopyFailedWithMessage: "Failed to copy project URL: {message}",
    resourceAnalysis: "Analysis",
    resourceCopyToAi: "Copy for AI",
    resourceAiHandoffTitle: "Hand off this resource",
    resourceAiHandoffDescription: "Copy a compact context with source, summary, evidence, and review tasks for Codex, Cursor, or Claude.",
    resourceCopyContext: "Copy context",
    resourceCopyingContext: "Copying",
    resourceContextCopied: "Resource context copied.",
    resourceCopyContextFailed: "Failed to copy resource context.",
    resourceCopyContextFailedWithMessage: "Failed to copy resource context: {message}",
    ...
    resourceAiContextPlaceholder: "Paste the copied context into Codex, Cursor, or Claude.",
