...
export const messages = {
  "zh-CN": {
    ...
    apiLensEyebrow: "本地接口观察",
    apiLensTitle: "API Lens",
    apiLensTargets: "目标服务",
    apiLensTargetName: "名称",
    apiLensTargetNamePlaceholder: "后端 API",
    apiLensBaseUrl: "服务地址",
    apiLensAddTarget: "添加目标",
    apiLensEmptyTargets: "添加一个本地后端地址后开始观察请求。",
    apiLensProxyUrl: "代理地址",
    apiLensNoTarget: "尚未选择目标",
    apiLensClear: "清空记录",
    apiLensRefresh: "刷新请求",
    apiLensGuideEyebrow: "怎么使用",
    apiLensGuideTitle: "用代理地址观察本地接口请求",
    apiLensGuideDescription: "先添加后端服务地址，再把前端开发环境的 API Base URL 临时改成代理地址。之后正常操作页面，请求会出现在下方列表。",
    apiLensStepTarget: "添加后端",
    apiLensStepTargetDetail: "例如 http://127.0.0.1:8000。",
    apiLensStepProxy: "复制代理",
    apiLensStepProxyDetail: "使用生成的 /lens/... 地址。",
    apiLensStepUse: "操作页面",
    apiLensStepUseDetail: "登录、保存、搜索等请求会被记录。",
    apiLensStepInspect: "交给 AI",
    apiLensStepInspectDetail: "详情里会自动脱敏并可复制上下文。",
    apiLensMethodFilter: "请求方法筛选",
    apiLensStatusFilter: "状态筛选",
    apiLensAllMethods: "全部方法",
    apiLensAllStatuses: "全部状态",
    apiLensErrors: "错误",
    apiLensSearchPlaceholder: "搜索路径、状态、错误...",
    apiLensRequests: "请求",
    apiLensEmptyRequests: "还没有请求。把前端 API 地址改为上方代理地址后再操作页面。",
    apiLensRequestDetail: "请求详情",
    apiLensMethod: "方法",
    apiLensStatus: "状态",
    apiLensDuration: "耗时",
    apiLensStartedAt: "时间",
    apiLensRequestBody: "请求预览",
    apiLensResponseBody: "响应预览",
    apiLensSelectRequest: "选择一条请求查看详情。",
    apiLensFailed: "失败",
    apiLensTargetAdded: "API Lens 目标已添加。",
    apiLensTargetFailed: "添加 API Lens 目标失败。",
    projectsEyebrow: "",
    projectsTitle: "",
  ...
  "en-US": {
    ...
    apiLensEyebrow: "Local API observation",
    apiLensTitle: "API Lens",
    apiLensTargets: "Targets",
    apiLensTargetName: "Name",
    apiLensTargetNamePlaceholder: "Backend API",
    apiLensBaseUrl: "Service URL",
    apiLensAddTarget: "Add target",
    apiLensEmptyTargets: "Add a local backend URL to start observing requests.",
    apiLensProxyUrl: "Proxy URL",
    apiLensNoTarget: "No target selected",
    apiLensClear: "Clear records",
    apiLensRefresh: "Refresh requests",
    apiLensGuideEyebrow: "How to use",
    apiLensGuideTitle: "Observe local API traffic through a proxy URL",
    apiLensGuideDescription: "Add your backend service, temporarily point the frontend API base URL to the proxy, then use the page normally. Requests appear below.",
    apiLensStepTarget: "Add backend",
    apiLensStepTargetDetail: "For example http://127.0.0.1:8000.",
    apiLensStepProxy: "Copy proxy",
    apiLensStepProxyDetail: "Use the generated /lens/... URL.",
    apiLensStepUse: "Use the page",
    apiLensStepUseDetail: "Login, save, search, and other calls are recorded.",
    apiLensStepInspect: "Hand off to AI",
    apiLensStepInspectDetail: "Details are redacted and can be copied as context.",
    apiLensMethodFilter: "Method filter",
    apiLensStatusFilter: "Status filter",
    apiLensAllMethods: "All methods",
    apiLensAllStatuses: "All statuses",
    apiLensErrors: "Errors",
    apiLensSearchPlaceholder: "Search paths, statuses, errors...",
    apiLensRequests: "Requests",
    apiLensEmptyRequests: "No requests yet. Point your frontend API base URL at the proxy above, then use the page.",
    apiLensRequestDetail: "Request detail",
    apiLensMethod: "Method",
    apiLensStatus: "Status",
    apiLensDuration: "Duration",
    apiLensStartedAt: "Time",
    apiLensRequestBody: "Request preview",
    apiLensResponseBody: "Response preview",
    apiLensSelectRequest: "Select a request to inspect it.",
    apiLensFailed: "Failed",
    apiLensTargetAdded: "API Lens target added.",
    apiLensTargetFailed: "Failed to add API Lens target.",
    projectsEyebrow: "",
    projectsTitle: "",
